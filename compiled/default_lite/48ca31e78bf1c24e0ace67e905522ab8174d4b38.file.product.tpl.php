<?php /* Smarty version Smarty-3.1.18, created on 2017-03-15 01:07:27
         compiled from "D:\OpenServer\OpenServer\domains\Medica\design\default_lite\html\product.tpl" */ ?>
<?php /*%%SmartyHeaderCode:351658c8699fa9faf8-05154465%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '48ca31e78bf1c24e0ace67e905522ab8174d4b38' => 
    array (
      0 => 'D:\\OpenServer\\OpenServer\\domains\\Medica\\design\\default_lite\\html\\product.tpl',
      1 => 1489080397,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '351658c8699fa9faf8-05154465',
  'function' => 
  array (
    'comments_tree' => 
    array (
  ...
  'unifunc' => 'content_58c869a0169ad1_74055828',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_58c869a0169ad1_74055828')) {function content_58c869a0169ad1_74055828($_smarty_tpl) {?><?php if (!is_callable('smarty_function_math')) include 'D:\\OpenServer\\OpenServer\\domains\\Medica\\Smarty\\libs\\plugins\\function.math.php';
if (!is_callable('smarty_modifier_date_format')) include 'D:\\OpenServer\\OpenServer\\domains\\Medica\\Smarty\\libs\\plugins\\modifier.date_format.php';
?>
...
" itemprop="name"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['product']->value->name, ENT_QUOTES, 'UTF-8', true);?>
		...
		<div class="row fn-transfer">
			...
			<div class="col-lg-5">
				<a class="fn-zoom okaycmslite btn-block relative border-a-1-info text-xs-center" href="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['resize'][0][0]->resize_modifier($_smarty_tpl->tpl_vars['product']->value->image->filename,800,600,'w');?>
" rel="group">
...
?>
					<div class="col-xs-4 col-lg-3">
						<a class="fn-zoom okaycmslite btn-block border-a-1-info text-xs-center product-images" href="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['resize'][0][0]->resize_modifier($_smarty_tpl->tpl_vars['image']->value->filename,800,600,'w');?>
" rel="group">
...
"/>
			...
			<?php } else { ?>
			<div class="col-lg-5">
				<a class="fn-zoom okaycmslite btn-block relative border-a-1-info text-xs-center" href="design/<?php echo $_smarty_tpl->tpl_vars['settings']->value->theme;?>
...
"/>
			...
			<div class="col-lg-7 fn-product" itemprop="offers" itemscope="" itemtype="http://schema.org/Offer">
				<form class="fn-variants okaycmslite row" action="/<?php echo $_smarty_tpl->tpl_vars['lang_link']->value;?>
cart">
					<div class="col-lg-6">
...
"><?php echo $_smarty_tpl->tpl_vars['lang']->value->product_sku;?>
                        ...
                        <select name="variant" class="fn-variant okaycmslite form-control c-select m-t-1 m-b-1-md_down<?php if (count($_smarty_tpl->tpl_vars['product']->value->variants)<2) {?> hidden-xs-up<?php }?>">
...
"><?php echo $_smarty_tpl->tpl_vars['lang']->value->product_out_of_stock;?>
                    	...
                    	<div class="fn-product-amount fn-is_stock okaycmslite text-xs-center text-md-left<?php if ($_smarty_tpl->tpl_vars['product']->value->variant->stock<1) {?> hidden-xs-up<?php }?>">
